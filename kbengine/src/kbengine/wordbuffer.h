...
{
    stack<vector<BufferEntry>> _buffer;
    int _maxSize;
public:
    KeyStrokeBuffer();
    ~KeyStrokeBuffer();

    UInt16 getLastWordSize();
    
    void resetBuffer();

    void addKeyStroke(UInt8 keycode, bool shiftCap);
    void startNewWord();
    void deleteLastKey();
};
...
//    T    getLastEntry();
//    unsigned long getWordSize();
//    
//    unsigned long getBufferSize();
//    UInt16 getBeginWordIndex();
//
//    void printBuffer();
//    
//    T& operator[](int);
...
//
//template <class T>
//unsigned long WordBuffer<T>::getWordSize()
//{
//    return _buffer.size() - _beginWordIdx;
//}
//
//template <class T>
//unsigned long WordBuffer<T>::getBufferSize()
//{
//    return _buffer.size();
//}
//
//template <class T>
//UInt16 WordBuffer<T>::getBeginWordIndex()
//{
//    return _beginWordIdx;
//}
//
//
//template <class T>
