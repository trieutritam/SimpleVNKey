...
map<UInt8, vector<vector<UInt16>>> syllableTable = {
    {
        KEY_A, {
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_A },
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_A, KEY_C },
            {MASK_ORIGIN,                            KEY_A, KEY_C, KEY_H},
            {MASK_ORIGIN,                            KEY_A, KEY_I},
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_A, KEY_M},
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_A, KEY_N},
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_A, KEY_N, KEY_G},
            {MASK_ORIGIN,                               KEY_A, KEY_N, KEY_H},
            {MASK_ORIGIN,                               KEY_A, KEY_O},
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_A, KEY_P},
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_A, KEY_T},
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_A, KEY_U},
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_A, KEY_Y},
        },
    },
    {
        KEY_E, {
    ...
    {
        KEY_O, {
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_O },
            {MASK_ORIGIN | MASK_ROOF | MASK_HOOK,   KEY_O, KEY_C },
    ...
    {   KEY_U, {
            {MASK_ORIGIN | MASK_HOOK, KEY_U },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_C },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_I },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_M },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_N },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_N, KEY_G },
            {MASK_ORIGIN                , KEY_U, KEY_P },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_T },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_U },
        
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_Y },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_Y, KEY_C, KEY_H },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_Y, KEY_N },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_Y, KEY_N, KEY_H },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_Y, KEY_P },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_Y, KEY_T },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_Y, KEY_U },
            {MASK_ORIGIN                , KEY_U, KEY_Y, KEY_A },
        
            // ua
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_A },
        
            {MASK_ORIGIN                , KEY_U, KEY_Y, KEY_E, KEY_N },
            {MASK_ORIGIN                , KEY_U, KEY_Y, KEY_E, KEY_T },
        
            // uo
            //{MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_O | MASK_EXTRA_MARK },   // Fix lỗi huơ, quơ, khuơ
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_O | MASK_EXTRA_MARK, KEY_C },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_O | MASK_EXTRA_MARK, KEY_I },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_O | MASK_EXTRA_MARK, KEY_M },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_O | MASK_EXTRA_MARK, KEY_N },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_O | MASK_EXTRA_MARK, KEY_N, KEY_G },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_O | MASK_EXTRA_MARK, KEY_P },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_O | MASK_EXTRA_MARK, KEY_T },
            {MASK_ORIGIN | MASK_HOOK, KEY_U, KEY_O | MASK_EXTRA_MARK, KEY_U },
        }
    },
};
...
vector<map<UInt32, vector<UInt16>>> codeTableList = {
    // Unicode
    {
        ...
        {KEY_A | MASK_HOOK,     { 0x0102, 0x0103, 0x1EAE, 0x1EAF, 0x1EB0, 0x1EB1, 0x1EB2, 0x1EB3, 0x1EB4, 0x1EB5, 0x1EB6, 0x1EB7 }},
        ...
        {KEY_O | MASK_HOOK,     { 0x01A0, 0x01A1, 0x1EDA, 0x1EDB, 0x1EDC, 0x1EDD, 0x1EDE, 0x1EDF, 0x1EE0, 0x1EE1, 0x1EE2, 0x1EE3 }},

        {KEY_U,                 { 0x0055, 0x0075, 0x00DA, 0x00FA, 0x00D9, 0x00F9, 0x1EE6, 0x1EE7, 0x0168, 0x0169, 0x1EE4, 0x1EE5 }},
        {KEY_U | MASK_HOOK,     { 0x01AF, 0x01B0, 0x1EE8, 0x1EE9, 0x1EEA, 0x1EEB, 0x1EEC, 0x1EED, 0x1EEE, 0x1EEF, 0x1EF0, 0x1EF1 }},
